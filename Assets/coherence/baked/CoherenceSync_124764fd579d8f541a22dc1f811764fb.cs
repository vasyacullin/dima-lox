...
namespace Coherence.Generated
{
    ...
    public class Binding_124764fd579d8f541a22dc1f811764fb_9be464d8874146b0b815f4eb87a3ee24 : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_124764fd579d8f541a22dc1f811764fb : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_124764fd579d8f541a22dc1f811764fb>();
        ...
        {
			["9be464d8874146b0b815f4eb87a3ee24"] = new Binding_124764fd579d8f541a22dc1f811764fb_9be464d8874146b0b815f4eb87a3ee24(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_124764fd579d8f541a22dc1f811764fb()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_124764fd579d8f541a22dc1f811764fb Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_124764fd579d8f541a22dc1f811764fb>();
            this.bridge = bridge;
